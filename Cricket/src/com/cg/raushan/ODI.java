...
class ODI extends Match               //inheritance(extend match class)
{
 public ODI(int score, float over, int target)  //parameter
 {
 ...
 balls=300-(balls+((int)super.currentOver*6));      //to calculate ball remain
 return balls;
 }
