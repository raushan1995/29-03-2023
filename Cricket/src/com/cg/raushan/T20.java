...
class T20 extends Match                //inheritance(extend match class)
{
 public T20(int score, float over, int target)    //parameter
 {
 ...
 balls=120-(balls+((int)super.currentOver*6));    //to calculate ball remain
 return balls;
 }
